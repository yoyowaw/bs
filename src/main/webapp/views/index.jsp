                ...
                <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
                    ...
                    <li data-name="template" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            ...
                            <dd><a href="login.html" target="_blank">登入</a></dd>
...
<script id="side-menu-tmp" type="text/html">
    {{each list}}
    <li data-name="home" class="layui-nav-item layui-nav-itemed">
        <a href="javascript:;" lay-tips="主页" lay-direction="2">
            <i class="layui-icon layui-icon-home"></i>
        ...
        <dl class="layui-nav-child">
            {{each $value.children}}
            <dd data-name="console" {{if $index == 0 }}class="layui-this"{{/if}} >
            <a lay-href="home/console.html">{{$value.name}}</a>
            </dd>
            {{/each}}
        </dl>
    </li>
...
<script>
    $.ajax({
        type: "GET",
        url: _basePath + "/resource/resourceMenu",
        data: {},
        dataType:"json",
        success: function (rs) {
            var html = template("side-menu-tmp", {"list": rs.data})
