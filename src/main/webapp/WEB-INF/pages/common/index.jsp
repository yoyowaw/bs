    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#btnEp").click(function () {
                var v = $("#editPasswordWordFrom").form("validate");
                if (v) {
        ...
        function logoutFun() {
            $.messager
                .confirm('系统提示', '您确定要退出本次登录吗?', function (isConfirm) {
                    if (isConfirm) {
                        location.href = '${pageContext.request.contextPath }/userLoginOut';
                    }
                });
        }
        ...
        // 版权信息
        function showAbout() {
            $.messager.alert("物流管理系统", "管理员邮箱: 172361131@qq.com");
        }
    </script>
</head>
...
<div data-options="region:'north',border:false"
    ...
    <div id="sessionInfoDiv"
        ...
        [<strong>超级管理员</strong>]，${ sessionScope.user.username }欢迎你！
    </div>
...
<div id="editPwdWindow" class="easyui-window" title="修改密码" collapsible="false" minimizable="false" modal="true"
    ...
    <div class="easyui-layout" fit="true">
        <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
            <form id="editPasswordWordFrom">
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input required="true" data-options="validType:'length[4,10]'" id="txtNewPass"
                                   type="Password" class="txt01 easyui-validatebox"/></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
                        <td><input required="true" data-options="validType:'length[4,10]'" id="txtRePass"
                                   type="Password" class="txt01  easyui-validatebox"/></td>
                    </tr>
                </table>
            </form>
