...
<script type="text/javascript">
	...
	function doDblClickRow(index,data){
		$('#association_subarea').datagrid( {
			...
			rownumbers : true,
			striped : true,
			url : "subarea_findList?id="+data.id,
			columns : [ [{
				field : 'id',
				title : '分拣编号',
				width : 120,
...
<body class="easyui-layout" style="visibility:hidden;">
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="staff.id"
    							data-options="valueField:'id',textField:'name',url:'/staff_query'" />
						</td>
					</tr>
					<tr height="300">
						<td valign="top">关联分区</td>
						<td>
							<table id="subareaGrid"  class="easyui-datagrid" border="false" style="width:300px;height:300px" data-options="url:'subareaAction_list',fitColumns:true,singleSelect:false">
								<thead>  
							        <tr>  
	...
	<div class="easyui-window" title="关联客户窗口" id="customerWindow" collapsible="false" closed="true" minimizable="false" maximizable="false" style="top:20px;left:200px;width: 400px;height: 300px;">
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="customerForm" action="/link_customer" method="post">
				<table class="table-edit" width="80%" align="center">
					<tr class="title">
